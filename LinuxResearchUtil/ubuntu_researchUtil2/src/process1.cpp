...
int process1::copyFileSet_dupFontsClean(){
	...
	remove("/usr/share/fonts/truetype/ttf-indic-fonts-core/MuktiNarrow.ttf");
	remove("/usr/share/fonts/truetype/ttf-indic-fonts-core/MuktiNarrowBold.ttf");
	remove("/usr/share/fonts/truetype/padauk/Padauk-bookbold.ttf");
	remove("/usr/share/fonts/truetype/padauk/Padauk-book.ttf");
	remove("/usr/share/fonts/truetype/padauk/Padauk-bold.ttf");
	remove("/usr/share/fonts/truetype/padauk/Padauk.ttf");

	remove("/usr/share/fonts/X11/Type1/Symbol.pfb");
	remove("/usr/share/fonts/X11/Type1/Symbol.afm");
	remove("/usr/share/fonts/truetype/fonts-japanese-gothic.ttf");
